...
const DEFAULT_FALLBACK_MENUS = [
  ...
  {
    id: "m-asi",
    nombre: "Distribución de asientos",
    rutaAccion: "/asientos",
    icono: "asientos",
    tipo: "menu",
    padreId: null,
...
const REPORTES_ITEMS = [
  ...
  { id: "rep-ingresos", nombre: "Reporte de ingresos" },
];
...
function MainMenu() {
  ...
  const handleReporteClick = (item) => {
    const reportRoutes = {
      ...
      "rep-ingresos": "/reportes/ingresos",
    };
  ...
  const serverMenus = (rol?.menus ?? []).filter(
    (m) => m.tipo === "menu" && m.padreId === null,
  );
...
{esAdmin() && (
  ...
  <header
    ...
    style={{
      ...
      left: 270,
      right: 0,
      height: "70px", // ajusta según tu diseño
      display: "flex",
  ...
  {/* Contenido con margen superior para no quedar oculto */}
